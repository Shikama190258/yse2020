...
// PHP自動整形用のファイル
//
// 次の記事の整形設定ファイルを使っています
// > ソースコードの“赤ペン先生”PHP-CS-Fixerのインストールと設定 - Qiita
// > https://qiita.com/suin/items/4242aec018d086312fe7

// 導入方法
//
// 自動整形用のツール(php cs fixer)の導入方法は次を参考に
// > Visual Studio CodeでPHPを整形する | Glatch Tech
// > https://tech.glatchdesign.com/php-cs-fixer-for-vscode
//
// PHPのPATHを通していないとエラーが出ます。次を参考に設定してください(「PHPの動作確認」には再起動が必要です)
// > PHPのパスを通す - XAMPPの使い方 - 開発メモ - Webkaru
