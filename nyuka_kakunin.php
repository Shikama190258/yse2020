			...
			<div id="center">
				<table>
					...
					<tbody>
						...
						?>
						<tr>
							<td><?php $book['title']/* (35) (34)で取得した書籍情報からtitleを表示する。 */;?></td>
							<td><?php $book['stock']/* (36) (34)で取得した書籍情報からstockを表示する。 */;?></td>
							<td><?php $stock /* (36) POSTの「stock」に設定されている値を(32)の変数を使用して呼び出す。 */;?></td>
						</tr>
